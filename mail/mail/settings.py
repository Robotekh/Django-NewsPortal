...
SECRET_KEY = 'django-insecure-7e2rhup*ig0-_is%bsl9%wle05id$kv!bztiao69ll24z3e&6&'
...
EMAIL_HOST_PASSWORD = 'peswkuxdadjfxmge'  # пароль от почты
EMAIL_USE_SSL = True  # Яндекс использует ssl, подробнее о том, что это, почитайте в дополнительных источниках, но включать его здесь обязательно


#Для рассылки группе админы
ADMINS = [
