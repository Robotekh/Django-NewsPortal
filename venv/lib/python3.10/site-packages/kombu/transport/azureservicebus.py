...
class Channel(virtual.Channel):
    ...
    def uamqp_keep_alive_interval(self) -> int:
        return self.transport_options.get('uamqp_keep_alive_interval')

    @cached_property
    def retry_total(self) -> int:
        return self.transport_options.get('retry_total')

    @cached_property
    def retry_backoff_factor(self) -> float:
        return self.transport_options.get('retry_backoff_factor')

    @cached_property
    def retry_backoff_max(self) -> int:
        return self.transport_options.get('retry_backoff_max')
