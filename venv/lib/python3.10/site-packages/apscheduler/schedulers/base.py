...
class BaseScheduler(six.with_metaclass(ABCMeta)):
    ...
    def _configure(self, config):
        ...
        self._job_defaults = {
            'misfire_grace_time': asint(job_defaults.get('misfire_grace_time')),
            'coalesce': asbool(job_defaults.get('coalesce')),
            'max_instances': asint(job_defaults.get('max_instances'))
        }
