...
def _extract_name_field(data, field_name):
    ...
    if v:
        if isinstance(v, str):
            ...
            preferred_locale = v.get("preferredLocale")
            locale_key = "_".join(
...
class LinkedInOAuth2Account(ProviderAccount):
    ...
    def get_avatar_url(self):
        ...
        req_size = profile_picture_config.get("display_size_w_h")
        req_auth_method = profile_picture_config.get("authorization_method")
