...
class CassandraBackend(BaseBackend):
    ...
    def __init__(self, servers=None, keyspace=None, table=None, entry_ttl=None,
        ...
        self.port = port or conf.get('cassandra_port')
        self.keyspace = keyspace or conf.get('cassandra_keyspace')
        self.table = table or conf.get('cassandra_table')
        ...
        expires = entry_ttl or conf.get('cassandra_entry_ttl')
        ...
        auth_provider = conf.get('cassandra_auth_provider')
        auth_kwargs = conf.get('cassandra_auth_kwargs')
