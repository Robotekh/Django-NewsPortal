...
class RedisBackend(BaseKeyValueStoreBackend, AsyncBackendMixin):
    ...
    def _chord_zset(self):
        return self._transport_options.get('result_chord_ordered')
...
class SentinelBackend(RedisBackend):
    ...
    def _get_sentinel_instance(self, **params):
        ...
        min_other_sentinels = self._transport_options.get("min_other_sentinels")
    ...
    def _get_pool(self, **params):
        ...
        master_name = self._transport_options.get("master_name")
