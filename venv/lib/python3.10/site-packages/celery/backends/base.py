...
class Backend:
    ...
    def __init__(self, app,
        ...
        self.always_retry = conf.get('result_backend_always_retry')
        self.max_sleep_between_retries_ms = conf.get('result_backend_max_sleep_between_retries_ms')
        self.base_sleep_between_retries_ms = conf.get('result_backend_base_sleep_between_retries_ms')
        self.max_retries = conf.get('result_backend_max_retries')
    ...
    def _call_task_errbacks(self, request, exc, traceback):
        ...
        if old_signature:
            ...
            if self.app.conf.task_always_eager or request.delivery_info.get('is_eager'):
                g.apply(
    ...
    def fallback_chord_unlock(self, header_result, body, countdown=1,
        ...
        priority = body.options.get('priority')
