...
SECRET_KEY = 'django-insecure-wi7xyz*-lj4+5l9)*5cuf#7wk=i)e$f1*96kkap=(hcm+@q*_^'
...
# декоратор перенаправит пользователя на страницу входа. После успешного завершения входа
# на сайт, сайт будет
# перенаправлен обратно на то представление, для которого был вызван декоратор
# LoginRequiredMixin в файле views.
